...
function ScrollPane:Create( x, y, width, height, relative, parent )
	local tab = {
		gui = false,
		buttons = 		{  },
		checkboxes = 	{  },
	...
	tab.gui = guiCreateScrollPane( x, y, width, height, ( type( relative ) == "boolean" ) and relative or false, parent );
	if( tab.gui ) then
